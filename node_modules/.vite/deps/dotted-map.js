...
var DottedMapWithoutCountries = class {
  ...
  getPin({ lat, lng }) {
    ...
    const inverse35 = lib_default(this.proj4String, "WGS84", [localx * this.X_RANGE / this.width + this.X_MIN, this.Y_MAX - localy * this.Y_RANGE / this.height]);
    if (!inverse35.every((v2) => Number.isFinite(v2))) return;
    const [localLng, localLat] = inverse35;
    return {
      x: localx,
      y: localy,
      lat: localLat,
